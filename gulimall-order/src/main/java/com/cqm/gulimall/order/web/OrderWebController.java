...
public class OrderWebController {
    ...
    @GetMapping("/toTrade")
    public String toTrade( Model model,RedirectAttributes redirectAttributes) throws ExecutionException, InterruptedException {
        //展示订单确认的数据

        OrderConfirmVo confirmVo =  orderService.confirmOrder();
        model.addAttribute("orderConfirmData",confirmVo);
        Object msg = redirectAttributes.getAttribute("msg");
        return "confirm";
    }
