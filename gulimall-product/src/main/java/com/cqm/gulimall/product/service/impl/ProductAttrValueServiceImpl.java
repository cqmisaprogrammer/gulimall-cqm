...
import com.cqm.gulimall.product.dao.ProductAttrValueDao;
...
//            this.baseMapper.update(entity,new QueryWrapper<ProductAttrValueEntity>().eq("spu_id",spuId).eq("attr_id",entity.getAttrId()));
//        }
